...
hpcx_load
export LD_LIBRARY_PATH=$HPCX_HOME/ucx/lib:$HPCX_HOME/ompi/lib:$HPCX_HOME/hcoll/lib:$HPCX_HOME/sharp/lib:$HPCX_HOME/ucc/lib:$HPCX_HOME/ncclnet_plugin/lib:$HPCX_HOME/nccl_rdma_sharp_plugin/lib
