...
# Run
mpirun --map-by ppr:4:node --bind-to numa bash -c 'export CUDA_VISIBLE_DEVICES=$OMPI_COMM_WORLD_LOCAL_RANK && ./xhpl_mxp-nvidia --nprow 2 --npcol 2 --nporder row --sloppy-type 2 --n 90000 --nb 384 --preset-gemm-kernel 0'