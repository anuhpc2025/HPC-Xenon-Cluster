...
# Allow whichever shm UCX was built with
export UCX_TLS=sm,self,cuda_copy,cuda_ipc,gdr_copy
export UCX_MEMTYPE_CACHE=n

# Try POSIX if present, otherwise fall back to CMA
export UCX_SHM_DEVICES=posix
