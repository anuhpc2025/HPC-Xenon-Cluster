...
# UCX for CUDA-heavy single-node job
export UCX_TLS=rc,self,cuda_copy,cuda_ipc
export UCX_IB_GPU_DIRECT_RDMA=no
export UCX_MEMTYPE_CACHE=y
export UCX_POSIX_USE_CMA=n
export UCX_POSIX_USE_PROC_LINK=y
...
# Run
mpirun --map-by ppr:4:node --bind-to none ./xhpl_mxp-nvidia --nprow 2 --npcol 2 --n 90000 --nb 384 --preset-gemm-kernel 80