...
#SBATCH --nodes=2                 #
#SBATCH --nodelist=node1,node3    # nodes 1 and 2 are the only ones with hpcx for now
...
export NCCL_PATH=/opt/nvidia/nvidia_hpc_benchmarks_openmpi/lib/nccl
export LD_PRELOAD=$NCCL_PATH/libnccl.so.2
export LD_LIBRARY_PATH=$NCCL_PATH:/opt/nvidia/nvidia_hpc_benchmarks_openmpi/lib/omp:/opt/nvidia/nvidia_hpc_benchmarks_openmpi/lib:/usr/local/cuda-12.6/lib64:/usr/lib/x86_64-linux-gnu/nvshmem/12:$LD_LIBRARY_PATH
