...
export NVSHMEM_USE_CUDA_MEMCPY=1
...
export OMPI_MCA_coll_tuned_allreduce_algorithm=5   # recursive doubling
export OMPI_MCA_coll_tuned_reduce_algorithm=6      # Rabenseifner
