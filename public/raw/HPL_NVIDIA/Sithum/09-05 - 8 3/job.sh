...
export OMPI_MCA_rmaps_base_mapping_policy="ppr:4:numa:pe=8"
export OMPI_MCA_hwloc_base_binding_policy=core

export UCX_TLS=rc_x,sm,cuda_copy,cuda_ipc
export UCX_NET_DEVICES=mlx5_0:1   # or mlx5_bond_0 if bonded
export UCX_IB_GPU_DIRECT_RDMA=yes
export UCX_RNDV_SCHEME=put_zcopy
export UCX_MEMTYPE_CACHE=n
export UCX_MAX_RNDV_RAILS=2
export UCX_IB_PCI_RELAXED_ORDERING=off   # since unsupported
